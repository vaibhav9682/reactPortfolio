  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://github.com/vaibhav9682"
            ...
            <li>
              <a
                href="mailto:vaibhav205.vd@gmail.com"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/Vaibhav70548070"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/vaibhav-dwivedi-li96?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3BPu9HTH1nSOyOBgh39a4kTw%3D%3D"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Developed with React JS</p>
        <div className="footer--social--icon">
          <Link
