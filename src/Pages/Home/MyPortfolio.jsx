  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a href="https://github.com/vaibhav9682" target="_blank">
      ...
      <div className="portfolio--section--container">
        {data?.portfolio?.map((item, index) => (
          <a href={item.host} target="_blank" key={index}>
            <div key={index} className="portfolio--section--card">
              <div className="cover-image outer">
                <div className=" inner image-container portfolio--section--img ">
                  <div className="front">
                    <img src={item.src1} alt="Front Image" />
                  </div>
                  <div className="back">
                    <img src={item.src2} alt="Back Image" />
                  </div>
                </div>
              </div>
              <div className="portfolio--section--card--content">
                <p className="host-view">Click to view</p>
                <div>
